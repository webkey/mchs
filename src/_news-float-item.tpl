<div class="news-float__item">
	@@if (context.label) { <div class="news__label news__label_@@label">@@label</div>}
	<a href="#" class="news-float__inner">
		@@if (context.src) { <div class="news-float__img" style="background-image: url(@@src);"></div>}
		<div class="news-float__content">
			@@if(context.title){ <div class="news-float__title">@@title</div>}
			<div class="news-float__text">@@text</div>
			<div class="news-float__meta">
