...
<div class="@@classKey-wrap">
	<@@if(context.navTag){nav}@@if(!context.navTag){div} class="@@classKey">
		<ul class="@@classKey__list @@classKey-js">
			<!--@@classKey item start-->
			<li class="has-drop@@if(mainNavItemActive === "Положение о департаменте"){ current}">
				@@include('_nav-LINK.tpl', { "itemText": "Положение о департаменте", "itemLink": "typography.html", "key": "@@classKey", "specialValue": "" })
			...
			<!--@@classKey item start-->
			<li class="has-drop@@if(mainNavItemActive === "Руководство"){ current}">
			...
			<!--@@classKey item start-->
			<li class="has-drop@@if(mainNavItemActive === "История"){ current}">
			...
			<!--@@classKey item start-->
			<li class="has-drop@@if(mainNavItemActive === "Подведомственные организации"){ current}">
				@@include('_nav-LINK.tpl', { "itemText": "Подведомственные организации", "itemLink": "404.html", "key": "@@classKey", "specialValue": "" })
			...
			<!--@@classKey item start-->
			<li class="has-drop@@if(mainNavItemActive === "График приёма граждан"){ current}">
