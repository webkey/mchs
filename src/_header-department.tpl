	...
	<div class="layout">
		<div class="header__holder">
			<div class="logo-wrap">
				<div class="logo">
					<a href="index.html">
						<img src="img/logo-chernobil.png" alt="Департамент по ликвидации последствий катастрофы на Чернобыльской АЭС МЧС РБ">
					</a>
				</div>
			</div>
				...
				<div class="header__top">
					...
					<ul class="user-options">
						...
						<li class="user-options__item news-opener">
							<a href="#" class="btn-news-open-js" title="Показать новости">
								<svg xmlns="http://www.w3.org/2000/svg" version="1.1" x="0px" y="0px" viewBox="0 0 87.6 100" style="enable-background:new 0 0 87.6 100;"> <path d="M86.2,25.5c-8-8-16-15.9-24-23.9c-0.6-0.6-1.3-1.1-2-1.5H5.3C5.2,0.1,5.1,0.1,5,0.2C2,0.8-0.2,3.5,0,6.6v86.6  c0,4.3,2.6,6.8,6.8,6.8h74c4.2,0,6.8-2.6,6.8-6.8V28.8C87.6,27.6,87.1,26.3,86.2,25.5z M62.6,11l14,14h-14V11z M81.3,90.2  c0,2.5-1.2,3.6-3.7,3.6h-68c-0.2,0-0.4,0-0.6,0c-1.7-0.2-3-1.7-2.9-3.4V9.9C6.3,8,7,6.8,8.5,6.4c0.3-0.1,0.7-0.1,1.1-0.1h46.7  c0,3,0,5.9,0,8.9v12.5c0,2.4,1.2,3.6,3.6,3.6h21.5V90.2z M65.3,75h-43c-2.1,0-3.5,1.3-3.5,3.1c0,1.8,1.4,3.1,3.5,3.1h21.4v0h21.6  c2.1,0,3.5-1.3,3.5-3.1C68.8,76.3,67.4,75,65.3,75z M22.2,43.7h18.1c2.1,0,3.5-1.3,3.5-3.1c0-1.8-1.4-3.1-3.5-3.1h-9c-3,0-6,0-9.1,0  c-0.2,0-0.3,0-0.5,0c-1.7,0.1-3,1.6-2.9,3.4C19,42.6,20.5,43.9,22.2,43.7z M43.8,50H22.2c-1.4-0.1-2.7,0.7-3.2,2  c-0.8,2.2,0.7,4.2,3.2,4.2h43.5c1.5,0,2.8-1.1,3.1-2.5c0.3-1.7-0.8-3.3-2.5-3.6C65.8,50,65.4,50,65,50L43.8,50L43.8,50z M65.6,62.5  H43.9l0,0H22c-1.6-0.1-2.9,1-3.2,2.6c-0.3,1.7,0.8,3.3,2.5,3.6c0.4,0.1,0.7,0.1,1.1,0.1h42.7c0.4,0,0.8,0,1.2-0.1  c1.5-0.3,2.6-1.6,2.6-3.2C68.7,63.8,67.3,62.4,65.6,62.5z"></path> </svg>
								<span>Новости</span>
							</a>
						</li>
					</ul>
					...
					<ul class="user-options">
						<li class="user-options__item search-link">
							<a href="search.html" title="Поиск" class="btn-search-open-js">
					...
					<!--user options end-->
					<!--go to site mchs-->
					<a href="index.html" class="go-to-mchs" title="Перейти на главный сайт МЧС Республики Беларусь"><span>Сайт МЧС РБ</span></a>
					<!--go to site mchs end-->
					@@include('_department-nav-base.tpl', { "mainNavItemActive": "@@mainNavItemActive", "classKey": "nav", "navTag": "true" })
				</div>
				<div class="header__content">
					<!--go to site mchs (for mobile)-->
					<a href="index.html" class="go-to-mchs--mob" title="Перейти на главный сайт МЧС Республики Беларусь"><span>Сайт МЧС РБ</span></a>
					<!--go to site mchs (for mobile) end-->
					<div class="logo">
						<a href="department-chernobil.html">
							<img src="img/logo-chernobil.png" alt="Департамент по ликвидации последствий катастрофы на Чернобыльской АЭС МЧС РБ">
							<strong>Департамент по ликвидации последствий катастрофы на Чернобыльской АЭС МЧС РБ</strong>
						</a>
					</div>
					<div class="header__hot-line">
						<div class="header__hot-line--align">
							<ul>
								<li>Горячая линия: <a href="tel:+375 (17) 289-15-96">+375 (17) 289-15-96</a></li>
								<li>В рабочие дни: 9:00 - 13:00; 14:00 - 18:00</li>
							</ul>
						</div>
					</div>
					<div class="holder">
						<div class="frame">
							<div class="header__title"><a href="department-chernobil.html">Департамент по ликвидации последствий катастрофы на Чернобыльской АЭС МЧС РБ</a></div>
							<ul class="header__info">
								<li class="hide-desk-md">
									...
									<span>220004, г. Минск, пр. Победителей, 23, корпус 1</span>
								</li>
								<li>
									<a href="tel:+375 (17) 289-15-96">
								...
								<li class="hide-desk-lg">
									<a href="mailto:home@komchern.org.by">
										...
										<span>home@komchern.org.by</span>
									</a>
								</li>
							</ul>
						</div>
