<!--obzh-->
<div class="obzh js-tabs" data-auto-height="false">
	<div class="obzh__nav">
			...
			<div class="obzh-banner" style="background-image: url(img/img-bozh-banner-01.jpg);">
				<div class="obzh-banner__content">
					<div class="obzh-banner__text">
						<ul>
							<li>Социальная реклама (видеоролики) МЧС Беларуси;</li>
							<li>Обучающие видеофильмы и уроки от МЧС Беларуси;</li>
							<li>Фильмы о спасателях.</li>
						</ul>
					</div>
					<div class="obzh-banner__footer">
			...
			<div class="obzh-banner" style="background-image: url(img/img-promo-slider-04.jpg);">
				<div class="obzh-banner__content">
					<div class="obzh-banner__text">
						<p>Самые читаемые материалы сайта МЧС за 2016 год.</p>
						<p>Гомель, 10:30</p>
						<p>Указом Президента присвоены специальные звания «полковник внутренней службы».</p>
						<p>Гродно, 10:20</p>
					</div>
					<div class="obzh-banner__footer">
						<a href="#" class="btn-default">Подробнее</a>
		...
		<div class="obzh__panel js-tab-content" id="obzh-id-05">
			<div class="obzh-banner" style="background-image: url(img/img-promo-slider-05.jpg);">
				<div class="obzh-banner__content">
					<div class="obzh-banner__text">
						<ul>
							<li>Представители регулирующих органов в области ядерной и радиационной безопасности Беларуси</li>
							<li>России обсудили дальнейшие шаги двустороннего взаимодействия.</li>
						</ul>
						<p>Принята единая позиция по проекту Технического регламента Евразийского экономического союза «О требованиях к средствам обеспечения пожарной безопасности и пожаротушения».</p>
					</div>
					<div class="obzh-banner__footer">
						<a href="#" class="btn-default">Подробнее</a>
					</div>
