		...
		<div class="header__holder">
			...
			<div class="header__frame">
				...
				<div class="header__content">
					...
					<div class="header__contacts">
						<ul>
							...
							<li>
								<a href="tel:112">
									<div>
										<em class="color--orange">101</em>
										<em>112</em>
									</div>
									<div><span>Круглосуточные номера МЧС</span></div>
								</a>
							</li>
						</ul>
					</div>
					<div class="holder">
						<div class="frame">
							<div class="header__title"><a href="index.html"><span>Министерство по чрезвычайным ситуациям Республики Беларусь</span></a></div>
