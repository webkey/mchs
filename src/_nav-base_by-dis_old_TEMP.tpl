	...
	<@@if(context.navTag){nav}@@if(!context.navTag){div} class="@@classKey">
		<ul class="@@classKey__list">
			...
			<li class="has-drop@@if(mainNavItemActive === "О министерстве"){ current}">
				...
				@@include('_nav-drop-wrap-1_ONE.tpl', { "dropLevel": "(==1==)", "start": "1", "key": "@@classKey"})
			...
			<li class="has-drop">
				...
				@@include('_nav-drop-wrap-2_TWO.tpl', { "start": "1", "key": "@@classKey"})
			<li class="has-drop">
				@@include('_nav-LINK.tpl', { "itemText": "Международное сотрудничество", "itemLink": "#", "key": "@@classKey", "specialValue": "" })

				@@include('_nav-drop-wrap-3_THREE.tpl', { "start": "1", "key": "@@classKey"})
			...
			<li>@@include('_nav-LINK.tpl', { "itemText": "Межгосударственный совет по черезвычайным ситуациям природного и техногенного характера (МГС по ЧС) и Корпус сил СНГ", "itemLink": "#", "key": "@@classKey", "specialValue": "" })</li>
				@@include('_nav-drop-wrap-3_THREE.tpl', { "end": "1", "key": "@@classKey"})
			...
			<li>@@include('_nav-LINK.tpl', { "itemText": "Спорт", "itemLink": "#", "key": "@@classKey", "specialValue": "" })</li>
				@@include('_nav-drop-wrap-2_TWO.tpl', { "end": "1", "key": "@@classKey"})
			...
			<li>@@include('_nav-LINK.tpl', { "itemText": "Сведенья о ЧС", "itemLink": "#", "key": "@@classKey", "specialValue": "" })</li>
				...
				@@include('_nav-drop-wrap-1_ONE.tpl', { "end": "1", "key": "@@classKey"})

			</li>
			<!--@@classKey item end-->

			<!--@@classKey item start-->
			<li class="has-drop@@if(mainNavItemActive === "Руководителям и ИП"){ current}">
				@@include('_nav-LINK.tpl', { "itemText": "Руководителям и ИП", "itemLink": "404.html", "key": "@@classKey", "specialValue": "" })

				@@include('_nav-drop-wrap-1_ONE.tpl', { "start": "1", "key": "@@classKey"})
			...
			<li class="has-drop">
				...
				@@include('_nav-drop-wrap-4_FOUR.tpl', { "start": "1", "key": "@@classKey"})
			...
			<li>@@include('_nav-LINK.tpl', { "itemText": "форма для обращения юрлица или ИП", "itemLink": "#", "key": "@@classKey", "specialValue": "" })</li>
				@@include('_nav-drop-wrap-4_FOUR.tpl', { "end": "1", "key": "@@classKey"})
			...
			<!--@@classKey item start-->
			<li class="has-drop@@if(mainNavItemActive === "Законодательство"){ current}">
				@@include('_nav-LINK.tpl', { "itemText": "Законодательство", "itemLink": "404.html", "key": "@@classKey", "specialValue": "" })
			...
			<!--@@classKey item start-->
			<li class="has-drop@@if(mainNavItemActive === "Электронные обращения"){ current}">
			...
			<!--@@classKey item start-->
			<li class="has-drop@@if(mainNavItemActive === "Вопрос-ответ"){ current}">
				@@include('_nav-LINK.tpl', { "itemText": "Вопрос-ответ", "itemLink": "404.html", "key": "@@classKey", "specialValue": "" })
			...
			<!--@@classKey item start-->
			<li class="has-drop@@if(mainNavItemActive === "Контакты"){ current}">
			...
			<!--@@classKey item start-->
			<li class="has-drop@@if(mainNavItemActive === "Еще..."){ current}">
				@@include('_nav-LINK.tpl', { "itemText": "Еще...", "itemLink": "404.html", "key": "@@classKey", "specialValue": "" })
